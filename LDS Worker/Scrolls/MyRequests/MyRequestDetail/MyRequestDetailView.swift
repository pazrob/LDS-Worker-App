...
//        expiredWarningLabel.bottomAnchor.constraint(equalTo: containerView.bottomAnchor, constant: -150).isActive = true
        ...
        //Buttons
        statusButton.topAnchor.constraint(equalTo: footerView.topAnchor, constant: 15).isActive = true
        statusButton.centerXAnchor.constraint(equalTo: footerView.centerXAnchor).isActive = true
        statusButton.widthAnchor.constraint(equalToConstant: 300).isActive = true
        statusButton.heightAnchor.constraint(equalToConstant: 40).isActive = true
        
        deleteButton.topAnchor.constraint(equalTo: statusButton.bottomAnchor, constant: 10).isActive = true
        deleteButton.centerXAnchor.constraint(equalTo: footerView.centerXAnchor).isActive = true
