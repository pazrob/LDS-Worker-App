...
extension GroupRequestsVC {
    ...
    func setUpCollectionView() {
        view.addSubview(groupRequestCollection)
        groupRequestCollection.fillSuperview()
    }
    ...
    ///When there are no cells being render
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let appDetailController = GroupRequestDC(post: groupPost)
